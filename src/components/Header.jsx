...
export default function Header() {
  return (
    <section className="row">
            {/* <img className="h-[60%] w-[80%] lg:h-[90vh] md:h-[50vh] lg:w-1/2 md:w-[55%]" src={bgImage} alt="Hero Background Vector" /> */}
            ...
            <div className="w-full lg:h-full h-auto grid md:grid-cols-2 absolute top-0 left-0 lg:px-24 md:px-8 px-5 pt-24 md:pt-32 lg:pt-0">
              ...
              <div className="h-[60%] w-[80%] lg:h-[90vh] md:h-[50vh] lg:w-1/2 md:w-[55%]">
                <img src="/images/HeroVector.png" alt="Exemple"  className='w-full h-full img-fluid'/>
            </div>
